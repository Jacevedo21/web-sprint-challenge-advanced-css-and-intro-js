...
function getArtistByIndex(array, index) {
  ...
  return `The artist at index ${art.id} is ${art.name}.`
  }
...
function removeArtist(array, index) {
  let length = artists.splice(index, 1)
  return length
}
...
let newArr = [];
function addArtist(newArr, name, years, genre, nationality, bio){
  newArr.push([name, years, genre, nationality, bio])
  return newArr
  }
  console.log(addArtist(artists, 'Jorge', '2001-5000', 'Web Design', 'American', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.'))
